...
\newcommand{\program}{Honours Computer Science}
\newcommand{\WTT}{f}
\newcommand{\name}{Keane Moraes}
\newcommand{\studentNumber}{20871920}

\newcommand{\yourStreet}{21B Street}
\newcommand{\yourCity}{Dubai}
\newcommand{\yourProvince}{Dubai}
\newcommand{\yourPostalCode}{193}
...
\begin{figure}[H]
	\includegraphics[width = 10cm]{uw_logo}
	\centering
